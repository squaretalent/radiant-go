...
Radiant::Initializer.run do |config|
  ...
  config.extensions = [:textile_filter, :layouts, :settings, :redirect, :navigation, :import_export, :drag,
                       :forms, :forms_mail, :paperclipped]
  ...
  config.action_controller.session = {
    :session_key => '_newr_session',
    :secret      => '82f81ab718e62de103f44cc031f40bf90fedaef3'
  }
